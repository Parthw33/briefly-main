          ...
          <div className="flex items-center gap-x-4 lg:gap-x-8">
            <div className="flex items-center gap-x-4">
              ...
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <Button size={isMobile ? "xs" : "sm"}>Paragraph</Button>
                </TooltipTrigger>
                <TooltipContent>
            ...
            <div className="flex items-center w-full gap-x-4">
              ...
              <div className="flex items-center justify-center gap-x-2 lg:gap-x-4">
                <span className="hidden text-sm md:flex">Short</span>
                ...
                <Tooltip delayDuration={0}>
                  ...
                  <TooltipContent>{textLength} words</TooltipContent>
                </Tooltip>
                <span className="hidden text-sm md:flex">Long</span>
              </div>
            ...
            {summarizedText?.length > 0 && (
              <AlertDialog>
                <Tooltip delayDuration={0}>
                  ...
                  <TooltipContent>Delete all text</TooltipContent>
                </Tooltip>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={handleDeleteText}>
                      Delete
                    </AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
